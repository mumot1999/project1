...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="css/user/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <!-- <link href="font-awesome/user/css/font-awesome.min.css" rel="stylesheet" type="text/css"> -->
